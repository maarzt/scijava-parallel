...
public class TestParameterProcessor extends ParameterProcessor {
	...
	public TestParameterProcessor(IOService ioService,
		ParameterTypeProvider typeProvider, ParallelWorker pw, String command)
	{
	...
	@Override
	protected ParallelizationParadigmParameterMapper getConvertor(
		String expectedType)
	{
	...
	private class P_DatasetConvertor implements
		ParallelizationParadigmParameterMapper
	{
