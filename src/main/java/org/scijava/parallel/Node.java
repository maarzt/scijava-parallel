...
public abstract class Node<T> {
	...
	public void addSuccessor(Node<T> successiveNode) {
		successors.add(successiveNode);
	}
	
	public void addSuccessors(List<Node<T>> successiveNodes) {
		successors.addAll(successiveNodes);
	}
	
	public void mergeNodes(List<Node<T>> nodes) {
		nodes.forEach(t -> t.addSuccessor(this));
	}
	
	// TODO: Do we want to go for the builder pattern and allow chaining when adding single successors?
